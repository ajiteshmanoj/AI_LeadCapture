  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Used by the chatbot to answer patient questions.</p>
      </div>
      <div className="grid grid-cols-1 gap-4">
        <Field label="Clinic name *"><Input value={name} onChange={(e) => setName(e.target.value)} placeholder="Raffles Medical Group" /></Field>
