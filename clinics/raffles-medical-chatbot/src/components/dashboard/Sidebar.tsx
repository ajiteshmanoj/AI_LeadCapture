...
const NAV = [
  ...
  { href: "/dashboard/waitlist", label: "Queue", icon: Clock },
  { href: "/dashboard/classes", label: "Consultation Types", icon: Stethoscope },
  { href: "/dashboard/locations", label: "Clinics", icon: MapPin },
