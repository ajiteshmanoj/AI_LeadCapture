      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <div className="flex items-end">
          <Button onClick={add} disabled={busy} className="w-full">
            {busy ? "Adding…" : "Add appointment type"}
          </Button>
        </div>
      </div>
        ...
        <table className="w-full text-sm">
          <thead className="bg-muted/40 border-b">
            <tr className="text-left">
              <th className="px-3 py-2 font-medium">Consultation Type</th>
              <th className="px-3 py-2 font-medium">Specialisation</th>
            ...
            {initialClasses.length === 0 && (
              <tr>
                <td colSpan={10} className="px-3 py-8 text-center text-muted-foreground">
                  No appointment types yet — add one above.
                </td>
              </tr>
            )}
          </tbody>
