...
const STORAGE_KEY = "rmg_conversation_id";
const PDPA_NOTICE =
  "By chatting, you agree to our data collection for appointment booking purposes. Type STOP to opt out. Note: this is not a medical helpline — for emergencies, call 995.";
