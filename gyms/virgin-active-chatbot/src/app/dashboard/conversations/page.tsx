      ...
      <div className="flex items-end justify-between flex-wrap gap-2">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            All chats from web + Telegram in one place. Escalated conversations are pinned to the top.
          </p>
        </div>
        {escalatedCount > 0 && (
            ...
            {sorted.length === 0 && (
              <tr>
                <td colSpan={5} className="px-4 py-12 text-center text-muted-foreground">
                  No conversations yet. Once parents start chatting, they&apos;ll show up here.
                </td>
              </tr>
            )}
          </tbody>
