...
const NAV = [
  ...
  { href: "/dashboard/bookings", label: "Class Bookings", icon: Calendar },
  { href: "/dashboard/waitlist", label: "Waitlist", icon: Clock },
  { href: "/dashboard/classes", label: "Classes", icon: Dumbbell },
  { href: "/dashboard/locations", label: "Clubs", icon: MapPin },
