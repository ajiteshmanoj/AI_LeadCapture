...
const STORAGE_KEY = "htg_conversation_id";
const PDPA_NOTICE =
  "By proceeding, you agree that Huttons Asia may collect and use your personal data for property matching and viewing purposes. Huttons Asia is licensed by the Council for Estate Agencies (CEA). Type STOP to opt out.";
