      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <Field label="Property Type">
          <Input
            ...
            placeholder="3BR Condo @ Bishan Park"
          />
        </Field>
        ...
        {/* monthly_fee hidden for property vertical — N/A */}
        ...
        <table className="w-full text-sm">
          <thead className="bg-muted/40 border-b">
            <tr className="text-left">
              <th className="px-3 py-2 font-medium">Property Title</th>
              <th className="px-3 py-2 font-medium">Budget Range</th>
              <th className="px-3 py-2 font-medium">Office</th>
              <th className="px-3 py-2 font-medium">Day</th>
              <th className="px-3 py-2 font-medium">Time</th>
              <th className="px-3 py-2 font-medium">Agent</th>
              <th className="px-3 py-2 font-medium">Viewing Slots</th>
