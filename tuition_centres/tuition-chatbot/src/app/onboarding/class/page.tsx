    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Classes power the booking flow — the chatbot reads seat counts and schedules directly from here. You can add more any time from the Classes page in your dashboard.
        </p>
      </div>
      <p className="text-sm text-muted-foreground rounded border bg-muted/30 p-4">
        Head to <strong>Dashboard → Classes</strong> after setup to add your classes. The booking flow needs at least one active class to work.
      </p>
