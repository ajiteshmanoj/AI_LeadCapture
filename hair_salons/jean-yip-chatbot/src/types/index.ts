...
export interface ClassRow {
  ...
  created_at: string;
  // Salon-specific extensions (011_salon_schema.sql)
...
export interface Booking {
  ...
  booking_type: "trial" | "assessment" | "makeup" | "appointment";
  booking_date: string;
  start_time: string;
  end_time: string;
...
export interface Stylist {
  ...
  location_id: string | null;
  name: string;
  tier: "Junior" | "Stylist" | "Senior" | "Principal" | "Creative Director";
